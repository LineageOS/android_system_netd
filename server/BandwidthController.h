...
protected:
    ...
    int manipulateRestrictAppsOnData(const char *iface, int numUids, char* appStrUids[], RestrictAppOp appOp);
    int manipulateRestrictAppsOnWlan(const char *iface, int numUids, char* appStrUids[], RestrictAppOp appOp);
