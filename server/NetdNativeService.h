...
class NetdNativeService : public BinderService<NetdNativeService>, public BnNetd {
  public:
    ...
    binder::Status bandwidthAddRestrictAppsOnInterface(const std::string& usecase, const std::string& ifName, int32_t uid) override;
    binder::Status bandwidthRemoveRestrictAppsOnInterface(const std::string& usecase, const std::string& ifName, int32_t uid) override;
